...
router.post("/changename", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                newUserNickname = req.body.username;
                return [4 /*yield*/, pool.query("UPDATE USERS SET USERNAME=$1 WHERE EMAIL=$2", [newUserNickname, req.body.email])];
            case 1:
                newNicknameReq = _a.sent();
